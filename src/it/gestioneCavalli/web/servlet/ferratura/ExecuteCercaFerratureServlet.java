...
/**
 * Servlet implementation class ExecuteCercaFerratureServlet
 */
@WebServlet("/eseCercaFerratureSer")
public class ExecuteCercaFerratureServlet extends HttpServlet {
	 ...
	 */
	public ExecuteCercaFerratureServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		FerraturaDTO fer = new FerraturaDTO(idCavallo, maniscalco, dataDa, dataA, tipo, prezzoDa, prezzoA);
		List<Ferratura> ferrature = ferraturaService.cercaByExample(fer);
