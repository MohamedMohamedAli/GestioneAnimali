...
/**
 * Servlet implementation class PrepareModificaFerraturaServlet
 */
@WebServlet("/preModificaFerraturaSer")
public class PrepareModificaFerraturaServlet extends HttpServlet {
	 ...
	 */
	public PrepareModificaFerraturaServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/ferratura/modificaFerratura.jsp").forward(request, response);
	}
