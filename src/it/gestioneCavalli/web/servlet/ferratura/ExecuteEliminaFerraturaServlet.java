...
/**
 * Servlet implementation class ExecuteEliminaFerraturaServlet
 */
@WebServlet("/eseEliminaFerraturaSer")
public class ExecuteEliminaFerraturaServlet extends HttpServlet {
	 ...
	 */
	public ExecuteEliminaFerraturaServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ferraturaService.elimina(idFerratura);
