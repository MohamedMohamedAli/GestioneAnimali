 ...
 */
@WebServlet("/preEliminaAlimentazioneSer")
public class PrepareEliminaAlimentazioneServlet extends HttpServlet {
	 ...
	 */
	public PrepareEliminaAlimentazioneServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/visita/eliminaAlimentazione.jsp").forward(request, response);
		}
