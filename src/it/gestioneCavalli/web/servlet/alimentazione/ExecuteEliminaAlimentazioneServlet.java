...
/**
 * Servlet implementation class ExecuteEliminaVisitaServlet
 */
@WebServlet("/eseEliminaAlimentazioneSer")
public class ExecuteEliminaAlimentazioneServlet extends HttpServlet {
	 ...
	 */
	public ExecuteEliminaAlimentazioneServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		visitaService.elimina(idVisita);
		...
		request.getRequestDispatcher("/visita/listaAlimentazione.jsp").forward(request, response);
	}
