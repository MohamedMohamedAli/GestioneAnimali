 ...
 */
@WebServlet("/eseInserisciAlimentazioneSer")
public class ExecuteInserisciAlimentazioneServlet extends HttpServlet {
	 ...
	 */
	public ExecuteInserisciAlimentazioneServlet() {
		super();
