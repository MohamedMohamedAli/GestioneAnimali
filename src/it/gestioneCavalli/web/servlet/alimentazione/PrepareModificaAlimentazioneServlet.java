...
/**
 * Servlet implementation class PrepareModificaVisitaServlet
 */
@WebServlet("/preModificaAlimentazioneSer")
public class PrepareModificaAlimentazioneServlet extends HttpServlet {
	 ...
	 */
	public PrepareModificaAlimentazioneServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/visita/modificaAlimentazione.jsp").forward(request, response);
	}
