...
/**
 * Servlet implementation class DettaglioDocumentoServlet
 */
@WebServlet("/dettaglioDocumentoSer")
public class DettaglioDocumentoServlet extends HttpServlet {
	 ...
	 */
	public DettaglioDocumentoServlet() {
		super();
...
//		Long idCavallo = Long.parseLong(request.getParameter("idCavallo"));
		...
		request.getRequestDispatcher("/documento/dettaglioDocumento.jsp").forward(request, response);
