...
/**
 * Servlet implementation class PrepareModificaDocumentoServlet
 */
@WebServlet("/preModificaDocumentoSer")
public class PrepareModificaDocumentoServlet extends HttpServlet {
	 ...
	 */
	public PrepareModificaDocumentoServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/documento/modificaDocumento.jsp").forward(request, response);
	}
