...
/**
 * Servlet implementation class ExecuteEliminaDocumentoServlet
 */
@WebServlet("/eseEliminaDocumentoSer")
public class ExecuteEliminaDocumentoServlet extends HttpServlet {
	 ...
	 */
	public ExecuteEliminaDocumentoServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		documentoService.elimina(idDocumento);
