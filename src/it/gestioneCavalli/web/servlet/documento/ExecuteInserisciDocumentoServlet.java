...
/**
 * Servlet implementation class ExecuteInserisciDocumentoServlet
 */
@WebServlet("/eseInserisciDocumentoSer")
public class ExecuteInserisciDocumentoServlet extends HttpServlet {
	 ...
	 */
	public ExecuteInserisciDocumentoServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		doc.setNote(note);
		doc.setAnimale(animale);
		
		documentoService.inserisci(doc);
