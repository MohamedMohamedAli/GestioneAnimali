...
/**
 * Servlet implementation class PrepareCompletaVaccinoServlet
 */
@WebServlet("/preCompletaVaccinoSer")
public class PrepareCompletaVaccinoServlet extends HttpServlet {
	 ...
	 */
	public PrepareCompletaVaccinoServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("cercaVaccini", cercaVaccini);
		...
		request.getRequestDispatcher("/vaccino/completaVaccino.jsp").forward(request, response);
	}
