...
/**
 * Servlet implementation class DettaglioVaccinoServlet
 */
@WebServlet("/dettaglioVaccinoSer")
public class DettaglioVaccinoServlet extends HttpServlet {
	 ...
	 */
	public DettaglioVaccinoServlet() {
		super();
...
//		Long idCavallo = Long.parseLong(request.getParameter("idCavallo"));
		...
		request.getRequestDispatcher("/vaccino/dettaglioVaccino.jsp").forward(request, response);
	}
