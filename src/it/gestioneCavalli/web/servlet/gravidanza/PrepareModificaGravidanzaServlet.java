...
/**
 * Servlet implementation class PrepareModificaGravidanzaServlet
 */
@WebServlet("/preModificaGravidanzaSer")
public class PrepareModificaGravidanzaServlet extends HttpServlet {
	 ...
	 */
	public PrepareModificaGravidanzaServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/gravidanza/modificaGravidanza.jsp").forward(request, response);
	}
