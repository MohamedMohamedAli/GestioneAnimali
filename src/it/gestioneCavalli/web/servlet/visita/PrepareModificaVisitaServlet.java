 ...
 */
@WebServlet("/preModificaVisitaSer")
public class PrepareModificaVisitaServlet extends HttpServlet {
	 ...
	 */
	public PrepareModificaVisitaServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/visita/modificaVisita.jsp").forward(request, response);
	}
