 ...
 */
@WebServlet("/preInserisciVisitaSer")
public class PrepareInserisciVisitaServlet extends HttpServlet {
	 ...
	 */
	public PrepareInserisciVisitaServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/visita/inserisciVisita.jsp").forward(request, response);
	}
