...
<body>
	...
	<div class="card-container">
		...
		<form class="form-horizontal"
			action="${pageContext.request.contextPath }/eseCompletaVaccinoSer"
			method="post">
			...
			<div class="card text-white bg-success"
				...
				<div class="card-header txt-center">
					<h3>Completa Vaccinazione</h3>
				</div>
				<div class="card-body center-card">

					<input type="hidden" value="${cercaVaccini}" name="cercaVaccini">
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" id="causaInputId"
							name="causaInput" value="vaccinazione">
					</div>
					<div class="form-group">
						<h5>
						...
						<input class="form-control" type="text" id="trattamentoInputId"
							name="trattamentoInput" value="${vaccinoAttr.tipo}">
					</div>
					<div class="form-group">
						<h5>
