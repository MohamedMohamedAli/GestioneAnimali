...
<body>
	...
	<div class="card-container">
		...
		<form class="form-horizontal"
			action="${pageContext.request.contextPath }/eseCercaCavalliSer"
			method="post">
			...
			<div class="card text-white bg-secondary"
				...
				<div class="card-body center-card">
					...
					<div class="form-group">
						<h5>
							<label class="control-label" for="statoInputId"><b>Stato:</b></label>
						</h5>
						<input type="checkbox" id="attiviId" name="attiviInput"
							value="true"> <label for="attiviId"> Attivi</label><br>
						<input type="checkbox" id="disabilitatiId"
							name="disabilitatiInput" value="true"> <label
							for="disabilitatiId"> Disabilitati</label><br>
					</div>
					<div class="form-group">
						<h5>
						...
						<div class="form-group">
							...
							<div class="form-group">
								...
								<div id="cavalloFemminaId">
									...
									<input type="checkbox" id="fatriceId" name="fattriceInput"
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<h5>
								<label class="control-label" for="dataDaId"><b>Nato
										Da:</b></label>
							</h5>
